...
```console
$ git clone git@github.com:bitExpert/sylius-2fa.git
$ cd sylius-2fa
```
...
2. Fork the repository (http://github.com/bitExpert/sylius-2fa)
...
```console
$ git remote add {username} git@github.com:{username}/sylius-2fa.git
$ git fetch {username}
```

### Keeping Up-to-Date

Periodically, you should update your fork or personal repository to match the canonical sylius-2fa repository.
...
To ssh://git@github.com/{username}/sylius-2fa.git
